...
namespace Valve.VR.InteractionSystem
{
    ...
    public class SyringeDraw : MonoBehaviour
    {
        public Transform movingPart;
        public GameObject drawSyringeGoal;
        public GameObject tutorial;
        public GameObject drawMedicine;
        ...
        private void HandHoverUpdate(Hand hand)
        {
            ...
            if (movingPart.localPosition == endPosition) {
                ...
                drawSyringeGoal.GetComponent<Text>().color = Color.green;
                drawSyringeGoal.GetComponent<AudioSource>().Play();
		        tutorial.GetComponent<TutorialCompletion>().ActionCompleted();
                isDrawn = true;
                drawMedicine.SetActive(false);
            }
